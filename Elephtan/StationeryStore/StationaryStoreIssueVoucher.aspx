<%@ Page Title="" Language="C#" MasterPageFile="~/SharedPages/DashboardMaster.Master" AutoEventWireup="true" CodeBehind="StationaryStoreIssueVoucher.aspx.cs" Inherits="Elephtan.StationeryStore.StationaryStoreIssueVoucher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <br />
            <asp:LinkButton runat="server" ID="doneButton" CssClass="btn btn-primary pull-right btn-lg" Text="Issue Voucher" OnClick="doneButton_Click"></asp:LinkButton>
        </div>
    </div>
